...
def View_Summary(uploaded_file):
    ...
    missing_check=latest_month_data[["Property_Name","Category","ENTITY",latest_month]][missing_check["Category"].isin(['Revenue','Patient Days','Operating Expenses',"Facility Information"])].groupby(["Property_Name","Category","ENTITY"]).sum().reset_index(drop=False)
